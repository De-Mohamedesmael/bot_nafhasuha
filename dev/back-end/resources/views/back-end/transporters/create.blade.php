...
@section('title', __('lang.add_transporter'))
@section('styles')
    <style>
        .crop-btn,.delete-btn {
            position: absolute;
...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.transporters.index")}}"> {{__('lang.transporters')}} </a> / </span>  @lang('lang.add_transporter')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_transporter')</div>

                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.transporters.store'), 'id' => 'transporter-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.transporters.partial.create_form')
    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#transporter-form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: $("form#transporter-form").attr("action"),
