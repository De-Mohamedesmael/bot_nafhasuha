...
@section('title', __('lang.add_splash_screen_'))
...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.splash_screen.index")}}"> {{__('lang.splash_screens')}} </a> / </span>  @lang('lang.add_splash_screen_')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_splash_screen_')</div>

                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.splash_screen.store'), 'id' => 'splash_screen-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.splash_screen.partial.create_form')
...
@section('javascript')
    ...
    <script src="{{ asset('assets/back-end/js/splash_screen_pst.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#splash_screen-form").valid()) {
                tinyMCE.triggerSave();
                document.getElementById("loader").style.display = "block";
                document.getElementById("content").style.display = "none";
                $.ajax({
                    type: "POST",
                    url: $("form#splash_screen-form").attr("action"),
                    data: $("#splash_screen-form").serialize(),
