            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => route('admin.provider.update', $provider->id), 'id' =>
                        'provider-form',
                        'method' =>
                                            ...
                                            <div class="preview-edit-container">
                                                @if(!empty($provider->getFirstMediaUrl('images')))
                                                    <div id="preview{{ $provider->id }}" class="preview">
                                                        ...
                                                        <img
                                                            src="{{  $provider->getFirstMediaUrl('images')  }}"
                                                            id="img{{  $provider->id }}" alt="">
                                                        <div class="action_div"></div>
                                                        <button type="button"
                                                                class="delete-btn"><i
                                                                style="font-size: 20px;"
                                                                data-href="{{ route('admin.provider.deleteImage', $provider->id) }}"
                                                                id="deleteBtn{{ $provider->id }}"
...
@section('javascript')
    <script>
        ...
        @if($provider)
        {{--document.getElementById("cropBtn{{ $provider->id }}").addEventListener('click', () => {--}}
        {{--    setTimeout(() => {--}}
        {{--        launchEditProductCropTool(document.getElementById("img{{ $provider->id }}"));--}}
        {{--    }, 500);--}}
        {{--});--}}
        document.getElementById("deleteBtn{{ $provider->id }}").addEventListener('click', () => {
            Swal.fire({
