...
@section('title', __('lang.add_cy_periodic'))
@section('styles')
    <style>
        div#content {
            padding-top: 0;
...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.cy_periodics.index")}}"> {{__('lang.cy_periodics')}} </a> / </span>  @lang('lang.add_provider')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_cy_periodic')</div>

                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.cy_periodics.store'), 'id' => 'cities-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.cy_periodics.partial.create_form')
