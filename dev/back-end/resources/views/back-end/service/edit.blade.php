...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => route('admin.service.update', $service->id), 'method' => 'put', 'id' => 'service_add_form', 'files' => true]) !!}

        <div class="modal-header">

            <h4 class="modal-title">@lang( 'lang.edit_service' )</h4>
        ...
        <div class="modal-body row">
            <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <div class="input-group my-group">
                            {!! Form::text('name', $service->title, ['class' => 'form-control', 'placeholder' => __('lang.name'), 'required']) !!}
                    ...
                    @include('back-end.layouts.partials.translation_inputs', [
                        'attribute' => 'title',
                        'translations' => $service->getTranslationsArray('title'),
                        'type' => 'service',
                    ])
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <div class="input-group my-group">
                        {!! Form::number('sort', $service->sort, ['class' => 'form-control', 'placeholder' => __('lang.sort'), 'required']) !!}
                        ...
                        <div class="row mx-0"
                            ...
                            <div class="col-10 offset-1">
                                <div class="preview-edit-container">
                                    @if($service)
                                        <div id="preview{{ $service->id }}" class="preview">
                                            @if ($service->image)
                                                <img src="{{asset('assets/images/'.$service->image) }}"
                                                     id="img{{  $service->id }}" alt="">
                                            @else
