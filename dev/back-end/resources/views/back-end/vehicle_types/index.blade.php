...
@endsection
@section('sli_li')
    <span class="parent"> < {{__('lang.vehicle_types')}} / </span>    @lang('lang.all_vehicle_types')
@endsection
@section('content')
    <div class="container-fluid">
        <div class="card-header d-flex align-items-center" style="justify-content: center">
            <div class="print-title">
                @lang('lang.all_vehicle_types')

            </div>
            <div  class="dev-create">


                <a  href="{{ route('admin.vehicle_types.create') }}" class="btn btn-create"><i
                        class="dripicons-plus"></i>
                    @lang('lang.add_vehicle_type')
                </a>
            </div>
