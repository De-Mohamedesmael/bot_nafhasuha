...
class FaqDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
            ->addColumn('action', 'store.view.faq.actions')
            ...
            ->editColumn('text_ar', function ($item) {
                ...
                return view('store.components.text', compact('id', 'desc'))->render();
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            'title_ar' => new Column(['title' => trans('store.title_ar'), 'data' => 'title_ar', 'orderable' => false]),
            'title_en' => new Column(['title' => trans('store.title_en'), 'data' => 'title_en', 'orderable' => false]),
            'text_ar' => new Column(['title' => trans('store.text_ar'), 'data' => 'text_ar', 'orderable' => false]),
            'text_en' => new Column(['title' => trans('store.text_en'), 'data' => 'text_en', 'orderable' => false]),
        ];
    }
