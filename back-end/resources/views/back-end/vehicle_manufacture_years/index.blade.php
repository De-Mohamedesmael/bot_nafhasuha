...
@section('title', __('lang.vehicle_manufacture_years'))
@section('styles')
    <style>
        input[type="checkbox"] {
...
@section('content')
    ...
    <div class="table-responsive">
        <table id="vehicle_manufacture_year_table" class="table">
            <thead>
            <tr>
                <th>#</th>
...
@section('javascript')
    <script>
        vehicle_manufacture_year__table = $("#vehicle_manufacture_year_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
            ...
            ajax: {
                url: '{{route("admin.vehicle_manufacture_years.index")}}',
                data: function (d) {
                    d.vehicle_manufacture_year_id = $("#vehicle_manufacture_year_id").val();
                },
            },
            columnDefs: [
                {
        ...
        $(document).on('click', '.delete_vehicle_manufacture_year', function(e) {
            e.preventDefault();
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_vehicle_manufacture_year_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
        ...
        $(document).on('click', '.update_status', function(e) {
            ...
            $.ajax({
                method: 'Post',
                url: "{{route('admin.vehicle_manufacture_years.update_status')}}",
                dataType: 'json',
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
