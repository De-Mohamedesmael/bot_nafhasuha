...
@section('content')
    <div class="container-fluid">
        <div class="card-header d-flex align-items-center">
            <h3 class="print-title">@lang('lang.all_banks')</h3>
        </div>
        <a style="color: white" href="{{ route('admin.banks.create') }}" class="btn btn-info"><i
                class="dripicons-plus"></i>
            @lang('lang.add_bank')</a>
...
@section('javascript')
    <script>
        bank_sales_table = $("#bank_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
            ...
            columns: [
                { data: "id", name: "id" },
                { data: "title", name: "bank_translations.title" },
        ...
        $(document).on('click', '.delete_bank', function(e) {
            ...
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_bank_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
