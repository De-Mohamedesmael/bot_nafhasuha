...
@section('content')
    <div class="container-fluid">
        <div class="card-header d-flex align-items-center">
            <h3 class="print-title">@lang('lang.all_areas')</h3>
        </div>
        <a style="color: white" href="{{ route('admin.areas.create') }}" class="btn btn-info"><i
                class="dripicons-plus"></i>
            @lang('lang.add_area')</a>
...
@section('javascript')
    <script>
        area__table = $("#area_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
            ...
            columns: [
                { data: "sort", name: "sort" },
                { data: "title", name: "area_translations.title" },
        ...
        $(document).on('click', '.delete_area', function(e) {
            ...
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_area_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
        ...
        $(document).on('click', '.update_status', function(e) {
            ...
            $.ajax({
                method: 'Post',
                url: "{{route('admin.areas.update_status')}}",
                dataType: 'json',
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
