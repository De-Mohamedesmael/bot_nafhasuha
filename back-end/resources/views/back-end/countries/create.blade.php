...
@section('title', __('lang.add_country'))
@section('styles')
    <style>
        div#content {
            padding-top: 0;
...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.countries.index")}}"> {{__('lang.countries')}} </a> / </span>  @lang('lang.add_country')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_country')</div>

                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.countries.store'), 'id' => 'countries-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.countries.partial.create_form')
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#countries-form").valid()) {
                tinyMCE.triggerSave();
                document.getElementById("loader").style.display = "block";
                document.getElementById("content").style.display = "none";
                $.ajax({
                    type: "POST",
                    url: $("form#countries-form").attr("action"),
                    data: $("#countries-form").serialize(),
