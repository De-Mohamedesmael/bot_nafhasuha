...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.countries.index")}}"> {{__('lang.countries')}} </a> / </span>  @lang('lang.edit_country')
@endsection
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <div class="print-title">@lang('lang.edit_country')</div>

                    </div>
                    <div class="card-body">
                        <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                        {!! Form::open(['url' => route('admin.countries.update', $country->id), 'id' =>
                        'country-form',
                        'method' =>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-group">
                                        {!! Form::text('title', $country->general_title , ['class' => 'form-control', 'placeholder' => __('lang.name'), 'required']) !!}
                                ...
                                @include('back-end.layouts.partials.translation_inputs', [
                                    'attribute' => 'title',
                                    'translations' => $country->getTranslationsArray('title'),
                                    'type' => 'notifications',
                                ])
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('sort', $country->sort, ['class' => 'form-control','required', 'placeholder' => __('lang.sort')]) !!}
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-group">
                                        {!! Form::number('count_number', $country->count_number, ['class' => 'form-control', 'placeholder' => __('lang.count_number'), 'required']) !!}
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-group">
                                        {!! Form::text('code_number', $country->code_number, ['class' => 'form-control', 'placeholder' => __('lang.code_number'), 'required']) !!}
                                        ...
                                        <div class="col-10 offset-1">
                                            ...
                                            <div class="preview-edit-container">
                                                @if(!empty($country->img))
                                                    <div id="preview{{ $country->id }}" class="preview">
                                                        <input type="hidden"  name="have_image"  value="1" id="have-image">
                                                        <img
                                                            src="{{ asset('assets/images/'.$country->img)  }}"
                                                            id="img{{  $country->id }}" alt="">
...
@section('javascript')
    <script>
        ...
        @if($country)
        {{--document.getElementById("cropBtn{{ $country->id }}").addEventListener('click', () => {--}}
        {{--    setTimeout(() => {--}}
        {{--        launchEditProductCropTool(document.getElementById("img{{ $country->id }}"));--}}
        {{--    }, 500);--}}
        {{--});--}}
        document.getElementById("deleteBtn{{ $country->id }}").addEventListener('click', () => {
            Swal.fire({
