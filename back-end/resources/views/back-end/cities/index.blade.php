...
@section('javascript')
    <script>
        city__table = $("#city_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
            ...
            columns: [
                { data: "sort", name: "sort" },
                { data: "title", name: "city_translations.title" },
                { data: "name_country", name: "country_translations.title" },
        ...
        $(document).on('click', '.delete_city', function(e) {
            ...
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_city_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
