...
@section('content')
    <div class="container-fluid">
        <div class="card-header d-flex align-items-center">
            <h3 class="print-title">@lang('lang.all_cy_periodics')</h3>
        </div>
        <a style="color: white" href="{{ route('admin.cy_periodics.create') }}" class="btn btn-info"><i
                class="dripicons-plus"></i>
            @lang('lang.add_cy_periodic')</a>
