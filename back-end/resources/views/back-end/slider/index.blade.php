...
@endsection
@section('sli_li')
    <span class="parent"> < {{__('lang.slider')}} / </span>    @lang('lang.all_sliders')
@endsection
@section('content')
    <div class="container-fluid">
        <div class="card-header d-flex align-items-center" style="justify-content: center">
            <div class="print-title">
                @lang('lang.all_sliders')

            </div>
            <div  class="dev-create">


                <a  href="{{ route('admin.slider.create') }}" class="btn btn-create"><i
                        class="dripicons-plus"></i>
                    @lang('lang.add_slider')
                </a>
            </div>
...
@section('javascript')
    <script>
        slider_sales_table = $("#slider_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
        ...
        $(document).on('click', '.delete_slider', function(e) {
            ...
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_slider_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
