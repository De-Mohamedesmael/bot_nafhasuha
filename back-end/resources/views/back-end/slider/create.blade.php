...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.slider.index")}}"> {{__('lang.slider')}} </a> / </span>  @lang('lang.add_slider')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_slider')</div>
                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.slider.store'), 'id' => 'slider-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.slider.partial.create_form')
...
@section('javascript')
    ...
    <script src="{{ asset('assets/back-end/js/slider_pst.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#slider-form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: $("form#slider-form").attr("action"),
