...
@section('title', __('lang.add_tire'))
@section('styles')
    <style>
        div#content {
            padding-top: 0;
...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.tires.index")}}"> {{__('lang.tires')}} </a> / </span>  @lang('lang.add_tire')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_tire')</div>

                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.tires.store'), 'id' => 'tire-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.tires.partial.create_form')
    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#tire-form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: $("form#tire-form").attr("action"),
