...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => route('admin.category.update', $category->id), 'method' => 'put', 'id' => 'category_add_form', 'files' => true]) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group my-group">
                        {!! Form::text('name', $category->title, ['class' => 'form-control', 'placeholder' => __('lang.name'), 'required']) !!}
                ...
                @include('back-end.layouts.partials.translation_inputs', [
                    'attribute' => 'title',
                    'translations' => $category->getTranslationsArray('title'),
                    'type' => 'category',
                ])
            </div>
            <div class="col-md-4">
                <div class="form-group ">
                    {!! Form::label('services', __('lang.services') . ':') !!}
                    {!! Form::select('services[]', $services, $category_services, ['class' => 'form-control', 'data-live-search' => 'true', 'multiple'=>'true','style' => 'width: 100%','id'=>'services_id', 'placeholder' => __('lang.please_select')]) !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <div class="input-group my-group">
                        {!! Form::number('sort', $category->sort, ['class' => 'form-control', 'placeholder' => __('lang.sort'), 'required']) !!}
