...
@section('title', __('lang.category_faqs'))
@section('styles')
    <style>
        input[type="checkbox"] {
...
@section('javascript')
    <script>
        category_faq__table = $("#category_faq_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
            ...
            ajax: {
                url: '{{route("admin.category_faqs.index")}}',
                data: function (d) {
                    d.category_faq_id = $("#category_faq_id").val();
                },
            },
            columnDefs: [
                {
            ...
            columns: [
                { data: "sort", name: "sort" },
                { data: "title", name: "category_faq_translations.title" },
        ...
        $(document).on('click', '.delete_category_faq', function(e) {
            e.preventDefault();
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_category_faq_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
