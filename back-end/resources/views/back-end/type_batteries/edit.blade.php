...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.type_batteries.index")}}"> {{__('lang.type_batteries')}} </a> / </span>  @lang('lang.edit_type_battery')
@endsection
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <div class="print-title">@lang('lang.edit_type_battery')</div>
