...
@endsection
@section('sli_li')
    <span class="parent"> < {{__('lang.providers')}} / </span>    @lang('lang.all_providers')
@endsection
@section('content')
    <div class="container-fluid">
        <div class="card-header d-flex align-items-center" style="justify-content: center">
            <div class="print-title">
                @lang('lang.all_providers')
            ...
            <div  class="dev-create">
                ...
                <a  href="{{ route('admin.provider.create') }}" class="btn btn-create"><i
                        class="dripicons-plus"></i>
                    @lang('lang.create') @lang('lang.provider')
                </a>
            </div>
...
@section('javascript')
    <script>
        provider_sales_table = $("#provider_table").DataTable({
            lengthChange: true,
            paging: true,
            info: false,
            bAutoWidth: false,
        ...
        $(document).on('click', '.delete_provider', function(e) {
            ...
            swal({
                title: 'Are you sure?',
                text: "@lang('lang.all_provider_transactions_will_be_deleted')",
                icon: 'warning',
            }).then(willDelete => {
                if (willDelete) {
        ...
        $(document).on('click', '.update_status', function(e) {
            ...
            $.ajax({
                method: 'Post',
                url: "{{route('admin.provider.update_status')}}",
                dataType: 'json',
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
