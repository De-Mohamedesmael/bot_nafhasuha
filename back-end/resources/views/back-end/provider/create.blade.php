...
@endsection
@section('sli_li')
    <span class="parent"> <  <a href="{{route("admin.provider.index")}}"> {{__('lang.providers')}} </a> / </span>  @lang('lang.add_provider')
@endsection
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="print-title">@lang('lang.add_provider')</div>
                        </div>
                        <div class="card-body">
                            <p class="italic"><small>@lang('lang.required_fields_info')</small></p>
                            {!! Form::open(['url' => route('admin.provider.store'), 'id' => 'provider-form', 'method' => 'POST', 'class' => '', 'enctype' => 'multipart/form-data']) !!}

                            @include('back-end.provider.partial.create_form')
...
@section('javascript')
    ...
    <script src="{{ asset('assets/back-end/js/provider_pst.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            if ($("#provider-form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: $("form#provider-form").attr("action"),
