                ...
                ->addColumn(
                    ...
                    function ($row) {
                        $html = ' <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" city="menu">';

//                            if (auth()->city()->can('city_module.city.delete')) {
                        $html .='<li>
                                                <a href="'. route('admin.city.edit',$row->id) .'" target="_blank"><i
...
//                            if (auth()->city()->can('city_module.city.delete')) {
                        $html .=
                            '<li>
                                    <a data-href="' . route('admin.city.delete', $row->id)  . '"
