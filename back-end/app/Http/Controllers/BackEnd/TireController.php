                ...
                ->addColumn(
                    ...
                    function ($row) {
                        $html = ' <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" tire="menu">';
                        ...
                        $html .='<li>
                                                <a href="'. route('admin.tires.edit',$row->id) .'" target="_blank"><i
                                                        class="dripicons-document-edit btn"></i>'.__('lang.edit').'</a>
                                            </li>';

//                        }
                        $html .= '<li class="divider"></li>';
//                            if (auth()->tire()->can('tire_module.tire.delete')) {
                                $html .=
                                    '<li>
                                    <a data-href="' . route('admin.tires.delete', $row->id)  . '"
